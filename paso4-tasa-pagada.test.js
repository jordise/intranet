...
ok('versión v104 en cabecera, título, PAGE_VERSION e historial', /VERSIÓN ACTUAL: v104 \|/.test(S) && /<title>Check-in Pasos v104/.test(S) && S.indexOf('var PAGE_VERSION = 104;') > 0 && /<!-- HISTORIAL: v104 - /.test(S));
