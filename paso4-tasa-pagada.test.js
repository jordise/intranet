...
ok('versión v106 en cabecera, título, PAGE_VERSION e historial', /VERSIÓN ACTUAL: v106 \|/.test(S) && /<title>Check-in Pasos v106/.test(S) && S.indexOf('var PAGE_VERSION = 106;') > 0 && /<!-- HISTORIAL: v106 - /.test(S) && / \| v104 - /.test(S));
