...
ok('versión v103 en cabecera, título, PAGE_VERSION e historial', /VERSIÓN ACTUAL: v103 \|/.test(S) && /<title>Check-in Pasos v103/.test(S) && S.indexOf('var PAGE_VERSION = 103;') > 0 && /<!-- HISTORIAL: v103 - /.test(S));
