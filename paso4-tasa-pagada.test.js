...
ok('versión v105 en cabecera, título, PAGE_VERSION e historial', /VERSIÓN ACTUAL: v105 \|/.test(S) && /<title>Check-in Pasos v105/.test(S) && S.indexOf('var PAGE_VERSION = 105;') > 0 && /<!-- HISTORIAL: v105 - /.test(S) && / \| v104 - /.test(S));
