/* Pruebas de los campos de instrucciones por suministro (electricidad, agua, gas) en la seccion
   Emergencias de editar-villa.html v26 y villa.html v22 (peticion de Nazaret, TIC, 13/09/2026).
...
var sEdit = checkPage('editar-villa.html', 28, /<title>Editar Villa v(\d+)/);
(function () {
  var ctx = {};
  ...
  ok('el historial v28, v27 y v26 no llevan nombres de personas ajenas ni horas', !/Amanda|\d{1,2}:\d{2}/.test(sEdit.slice(sEdit.indexOf('<!-- HISTORIAL: v28'), sEdit.indexOf('| v25 - '))));
})();

checkPage('villa.html', 24, /<title>Villa Info v(\d+)/);
