...
var sEdit = checkPage('editar-villa.html', 27, /<title>Editar Villa v(\d+)/);
(function () {
  var ctx = {};
  ...
  ok('el historial v27 y v26 no llevan nombres de personas ajenas ni horas', !/Amanda|\d{1,2}:\d{2}/.test(sEdit.slice(sEdit.indexOf('<!-- HISTORIAL: v27'), sEdit.indexOf('| v25 - '))));
})();

checkPage('villa.html', 23, /<title>Villa Info v(\d+)/);
