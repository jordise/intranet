/* Pruebas del early check-in por hora (checkin-pasos v102, notas-equipo-reservas v80,
...
ok('checkin-pasos v106', /VERSIÓN ACTUAL: v106 \|/.test(S) && S.indexOf('var PAGE_VERSION = 106;') > 0 && /<!-- HISTORIAL: v106 - /.test(S) && / \| v104 - /.test(S));
