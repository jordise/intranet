...
(function () {
  ...
  ok('v101 en PAGE_VERSION, cabecera y titulo', pv && hv && tv && pv[1] === '101' && hv[1] === '101' && tv[1] === '101', [pv && pv[1], hv && hv[1], tv && tv[1]].join('/'));
  ok('historial v101', /<!-- HISTORIAL: v101 - /.test(s));
...
(function () {
  ...
  ok('v81 en PAGE_VERSION, cabecera y titulo', pv && hv && tv && pv[1] === '81' && hv[1] === '81' && tv[1] === '81', [pv && pv[1], hv && hv[1], tv && tv[1]].join('/'));
  ok('historial v81', /<!-- HISTORIAL: v81 - /.test(s) && / \| v80 - /.test(s));
