...
(function () {
  ...
  ok('v105 en PAGE_VERSION, cabecera y titulo', pv && hv && tv && pv[1] === '105' && hv[1] === '105' && tv[1] === '105', [pv && pv[1], hv && hv[1], tv && tv[1]].join('/'));
  ok('historial v105', /<!-- HISTORIAL: v105 - /.test(s) && / \| v104 - /.test(s));
