...
(function () {
  ...
  ok('v106 en PAGE_VERSION, cabecera y titulo', pv && hv && tv && pv[1] === '106' && hv[1] === '106' && tv[1] === '106', [pv && pv[1], hv && hv[1], tv && tv[1]].join('/'));
  ok('historial v106', /<!-- HISTORIAL: v106 - /.test(s) && / \| v104 - /.test(s));
...
(function () {
  ...
  ok('v82 en PAGE_VERSION, cabecera y titulo', pv && hv && tv && pv[1] === '82' && hv[1] === '82' && tv[1] === '82', [pv && pv[1], hv && hv[1], tv && tv[1]].join('/'));
  ok('historial v82', /<!-- HISTORIAL: v82 - /.test(s) && / \| v81 - /.test(s));
