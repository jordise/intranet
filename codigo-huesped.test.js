...
(function () {
  ok('cabecera v78', /VERSIÓN ACTUAL: v78 \|/.test(SRC));
  ok('titulo v78', /<title>Notas Equipo Reservas v78 — 3Villas<\/title>/.test(SRC));
  ok('PAGE_VERSION 78 (la auto-recarga mira este numero)',
    SRC.indexOf('var PAGE_VERSION = 78;') > 0 && SRC.indexOf('var PAGE_VERSION = 77;') < 0);
  ...
  ok('el historial empieza en v78 y nombra el cambio de permiso',
    /<!-- HISTORIAL: v78 - /.test(SRC) && /notas-equipo-reservas/.test(SRC));
