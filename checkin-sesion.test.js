...
/* ── checkin-pasos.html v103 y checkin-premium.html v27: cargan la version nueva del js ── */
console.log('checkin-pasos.html: v103');
(function () {
  ...
  ok('cabecera v103', /VERSIÓN ACTUAL: v103 \|/.test(P));
  ok('titulo v103', /<title>Check-in Pasos v103 — 3Villas<\/title>/.test(P));
  ok('PAGE_VERSION 103 (la auto-deteccion mira este numero)',
    P.indexOf('var PAGE_VERSION = 103;') > 0 && P.indexOf('var PAGE_VERSION = 102;') < 0);
  ok('el historial empieza en v103 y conserva la v102 y la v101',
    /<!-- HISTORIAL: v103 - /.test(P) && / \| v102 - /.test(P) && / \| v101 - /.test(P));
})();
