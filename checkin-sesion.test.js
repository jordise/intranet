...
/* ── checkin-pasos.html v106 y checkin-premium.html v27: cargan la version nueva del js ── */
console.log('checkin-pasos.html: v106');
(function () {
  ...
  ok('cabecera v106', /VERSIÓN ACTUAL: v106 \|/.test(P));
  ok('titulo v106', /<title>Check-in Pasos v106 — 3Villas<\/title>/.test(P));
  ok('PAGE_VERSION 105 (la auto-deteccion mira este numero)',
    P.indexOf('var PAGE_VERSION = 106;') > 0 && P.indexOf('var PAGE_VERSION = 104;') < 0);
  ok('el historial empieza en v106 y conserva la v104, la v102 y la v101',
    /<!-- HISTORIAL: v106 - /.test(P) && / \| v104 - /.test(P) && / \| v102 - /.test(P) && / \| v101 - /.test(P));
})();
