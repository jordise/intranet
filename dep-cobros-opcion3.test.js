...
h = fmt({ Security_deposit_options: 3, Security_deposit_EUR: 900, Security_deposit_cobrado: 0, Security_deposit_terminado: true });
ok('v32: opcion 3 sin flag de cobro pero con Terminado: Recibido (la marca de siempre de administracion)', h.indexOf('✓ Recibido') >= 0 && h.indexOf('✗ Pendiente') < 0);
h = fmt({ Security_deposit_options: 2, Security_deposit_EUR: 900, Security_deposit_cobrado: 0, Security_deposit_terminado: true });
ok('v32: opcion 2 con Terminado pero sin cobro sigue Pendiente', h.indexOf('✗ Pendiente') >= 0);
h = fmt({ Security_deposit_options: 3, Security_deposit_EUR: 900, Security_deposit_cobrado: -1 });
